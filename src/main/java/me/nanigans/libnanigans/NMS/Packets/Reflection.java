...
public class Reflection {
    public static Class<?> getClass(JavaPlugin plugin, String classname) {
        try {
    ...
    public static void sendAllPacket(JavaPlugin plugin, Object packet) throws Exception {
        for (Player p : Bukkit.getOnlinePlayers()) {
            Object nmsPlayer = getNmsPlayer(p);
            Object connection = nmsPlayer.getClass().getField("playerConnection").get(nmsPlayer);
            connection.getClass().getMethod("sendPacket", Reflection.getClass(plugin, "{nms}.Packet")).invoke(connection, packet);
        }
    }
    public static void sendListPacket(JavaPlugin plugin, List<String> players, Object packet) {
        try {
    ...
    public static void sendPlayerPacket(JavaPlugin plugin, Player p, Object packet) throws Exception {
        Object nmsPlayer = getNmsPlayer(p);
        Object connection = nmsPlayer.getClass().getField("playerConnection").get(nmsPlayer);
        connection.getClass().getMethod("sendPacket", Reflection.getClass(plugin, "{nms}.Packet")).invoke(connection, packet);
    }
